...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, get_payload_client_1.getPayloadClient)({
                    initOptions: {
                        express: app,
            ...
            case 1:
                ...
                if (process.env.NEXT_BUILD) {
                    app.listen(PORT, function () {
                        payload.logger.info("Nextjs is building for production. Server started on ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                        //@ts-expect-error
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () {
                        payload.logger.info("Server started on ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                    });
                });
                return [2 /*return*/];
        }
